...
class SentenceChunker:
    ...
    # Split after . ! ? when followed by whitespace, keeping the punctuation.
...
class RecursiveChunker:
    ...
    def _split(self, current_text: str, remaining_separators: list[str]) -> list[str]:
        ...
        # No separator left (or the empty one): fall back to a hard character cut.
        ...
        for part in current_text.split(separator):
            ...
            if len(part) > self.chunk_size:
                chunks.extend(self._split(part, rest))  # still too big: next separator
            else:
                buffer = part
